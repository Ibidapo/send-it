...
// Put request to change destination of a parcel order by Id
router.put('/:id/status', authenticate.admin, validation.changeParcelStatus, parcelController.changeParcelStatus);

// Put request to change destination of a parcel order by Id
router.put('/:id/presentLocation', authenticate.admin, validation.changeParcelPresentLocation, parcelController.changeParcelPresentLocation);
