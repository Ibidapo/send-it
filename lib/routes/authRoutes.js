...
router.get('/forgotPassword', validation.forgotPassword, userController.forgotPassword);

// GET request to render password page and form
router.get('/resetPassword', validation.resetPassword, userController.resetPassword);
