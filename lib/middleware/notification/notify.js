...
class Notify {
  static addParcelMail(req) {
    ...
    sendNotification(parcel[0].user_id, `[SendIT] Created Order #${parcel[0].parcel_id}`, message);
  }
  ...
  static cancelParcelMail(req) {
    ...
    sendNotification(parcel[0].user_id, `[SendIT] Cancelled Order #${parcel[0].parcel_id}`, message);
  }
  ...
  static changeDestinationMail(req) {
    ...
    sendNotification(parcel[0].user_id, `[SendIT] Updated Order #${parcel[0].parcel_id}`, message);
  }
